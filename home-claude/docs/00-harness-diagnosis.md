...
produced by execution, not reasoning; acceptance checks for substantive work — the
high-risk / high-uncertainty line drawn in `20-judgment-rubrics.md` § 2, delegated or done in
the main conversation — run in a **fresh-context** agent given only the acceptance criteria
(never the doer's chat log);
